...
plt.tight_layout()
plt.savefig(TEST_DIR / "classification_performance_across_cnv_size_cumulative.png", dpi=300)
...
plt.tight_layout()
plt.savefig(TEST_DIR / "classification_performance_across_cnv_size_density.png", dpi=300)
...
n_rows = write_sensitivity_tsv(TEST_DIR / "sobol_indices.tsv", sensitivity)
print(f"wrote {n_rows} rows to {TEST_DIR / 'sobol_indices.tsv'}")
