...
process_file() {
    ...
    echo "    \"${tool_1_name}_${tool_2_name}\": $(wc -l < "$tool_1_tool_2_intersect")," >> "$log_file"
    echo "    \"${tool_1_name}_${tool_3_name}\": $(wc -l < "$tool_1_tool_3_intersect")," >> "$log_file"
    echo "    \"${tool_2_name}_${tool_3_name}\": $(wc -l < "$tool_2_tool_3_intersect")" >> "$log_file"
    echo "  }" >> "$log_file"
    ...
    echo "    \"${tool_1_name}_${tool_3_name}\": $(wc -l < "$tool_1_tool_3")," >> "$log_file"
    echo "    \"${tool_2_name}_${tool_3_name}\": $(wc -l < "$tool_2_tool_3")" >> "$log_file"
    echo "  }" >> "$log_file"
